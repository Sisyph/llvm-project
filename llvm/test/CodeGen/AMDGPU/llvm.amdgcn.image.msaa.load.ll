...
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    v_dual_mov_b32 v9, 0 :: v_dual_mov_b32 v10, v9 ; encoding: [0x80,0x00,0x10,0xca,0x09,0x01,0x0a,0x09]
...
; GFX12-NEXT:    v_dual_mov_b32 v11, v9 :: v_dual_mov_b32 v12, v9 ; encoding: [0x09,0x01,0x10,0xca,0x09,0x01,0x0c,0x0b]
; GFX12-NEXT:    v_dual_mov_b32 v13, v9 :: v_dual_mov_b32 v0, v9 ; encoding: [0x09,0x01,0x10,0xca,0x09,0x01,0x00,0x0d]
; GFX12-NEXT:    v_dual_mov_b32 v1, v10 :: v_dual_mov_b32 v2, v11 ; encoding: [0x0a,0x01,0x10,0xca,0x0b,0x01,0x02,0x01]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) ; encoding: [0x02,0x00,0x87,0xbf]
; GFX12-NEXT:    v_dual_mov_b32 v3, v12 :: v_dual_mov_b32 v4, v13 ; encoding: [0x0c,0x01,0x10,0xca,0x0d,0x01,0x04,0x03]
