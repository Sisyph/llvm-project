...
; RUN: llc -mtriple=amdgcn -mcpu=gfx803 < %s | FileCheck -check-prefixes=GCN,GFX803 -check-prefixes=GCN,GFX803 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GCN,GFX9 -check-prefixes=GCN,GFX9 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1010 < %s | FileCheck -check-prefixes=GCN,GFX10 -check-prefixes=GCN,GFX10 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GCN,GFX11 -check-prefixes=GCN,GFX11 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GCN,GFX112 -check-prefixes=GCN,GFX112 %s
...
; GFX8-NEXT:    s_endpgm
;
; GFX803-LABEL: mad_u16:
; GFX803:       ; %bb.0: ; %entry
; GFX803-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x24
; GFX803-NEXT:    v_lshlrev_b32_e32 v4, 1, v0
; GFX803-NEXT:    s_waitcnt lgkmcnt(0)
; GFX803-NEXT:    v_mov_b32_e32 v1, s3
; GFX803-NEXT:    v_add_u32_e32 v0, vcc, s2, v4
; GFX803-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX803-NEXT:    v_mov_b32_e32 v3, s5
; GFX803-NEXT:    v_add_u32_e32 v2, vcc, s4, v4
; GFX803-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
; GFX803-NEXT:    v_mov_b32_e32 v5, s7
; GFX803-NEXT:    v_add_u32_e32 v4, vcc, s6, v4
; GFX803-NEXT:    v_addc_u32_e32 v5, vcc, 0, v5, vcc
; GFX803-NEXT:    flat_load_ushort v6, v[0:1] glc
; GFX803-NEXT:    s_waitcnt vmcnt(0)
; GFX803-NEXT:    flat_load_ushort v2, v[2:3] glc
; GFX803-NEXT:    s_waitcnt vmcnt(0)
; GFX803-NEXT:    flat_load_ushort v3, v[4:5] glc
; GFX803-NEXT:    s_waitcnt vmcnt(0)
; GFX803-NEXT:    v_mov_b32_e32 v0, s0
; GFX803-NEXT:    v_mov_b32_e32 v1, s1
; GFX803-NEXT:    v_mad_u16 v2, v6, v2, v3
...
; GFX11-NEXT:    global_load_d16_b16 v0, v1, s[2:3] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_load_d16_hi_b16 v0, v1, s[4:5] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_load_d16_b16 v1, v1, s[6:7] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_mad_u16 v0.l, v0.l, v0.h, v1.l
...
; GFX112-NEXT:    global_load_u16 v2, v0, s[4:5] glc dlc
; GFX112-NEXT:    s_waitcnt vmcnt(0)
; GFX112-NEXT:    global_load_u16 v0, v0, s[6:7] glc dlc
; GFX112-NEXT:    s_waitcnt vmcnt(0)
; GFX112-NEXT:    v_mad_u16 v0, v1, v2, v0
; GFX112-NEXT:    global_store_b16 v3, v0, s[0:1]
; GFX112-NEXT:    s_endpgm
...
;
; GFX803-LABEL: v_mad_u16:
; GFX803:       ; %bb.0:
; GFX803-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX803-NEXT:    v_mad_u16 v0, v0, v1, v2
...
; GFX11-NEXT:    v_mad_u16 v0.l, v0.l, v1.l, v2.l
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX112-LABEL: v_mad_u16:
; GFX112:       ; %bb.0:
; GFX112-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX112-NEXT:    v_mad_u16 v0, v0, v1, v2
; GFX112-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX112-LABEL: v_mad_u16_zext:
; GFX112:       ; %bb.0:
; GFX112-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX112-NEXT:    v_mad_u16 v0, v0, v1, v2
; GFX112-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX112-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX112-NEXT:    s_setpc_b64 s[30:31]
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX803-LABEL: v_mad_u16_zext64:
; GFX803:       ; %bb.0:
; GFX803-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX803-NEXT:    v_mad_u16 v0, v0, v1, v2
; GFX803-NEXT:    v_mov_b32_e32 v1, 0
; GFX803-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX112-LABEL: v_mad_u16_zext64:
; GFX112:       ; %bb.0:
; GFX112-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX112-NEXT:    v_mad_u16 v0, v0, v1, v2
; GFX112-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX112-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v0, 0xffff, v0
; GFX112-NEXT:    s_setpc_b64 s[30:31]
...
;
; GFX803-LABEL: s_mad_u16:
; GFX803:       ; %bb.0:
; GFX803-NEXT:    s_mul_i32 s0, s0, s1
; GFX803-NEXT:    s_add_i32 s0, s0, s2
; GFX803-NEXT:    ; return to shader part epilog
;
...
;
; GFX112-LABEL: s_mad_u16:
; GFX112:       ; %bb.0:
; GFX112-NEXT:    s_mul_i32 s0, s0, s1
; GFX112-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX112-NEXT:    s_add_i32 s0, s0, s2
; GFX112-NEXT:    ; return to shader part epilog
  %mul = mul i16 %arg0, %arg1
  %add = add i16 %mul, %arg2
  ret i16 %add
}
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX112-LABEL: s_mad_u16_zext:
; GFX112:       ; %bb.0:
; GFX112-NEXT:    s_mul_i32 s0, s0, s1
; GFX112-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX112-NEXT:    s_add_i32 s0, s0, s2
; GFX112-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX112-NEXT:    ; return to shader part epilog
  %mul = mul i16 %arg0, %arg1
  %add = add i16 %mul, %arg2
  %zext = zext i16 %add to i32
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX112-LABEL: s_mad_u16_zext64:
; GFX112:       ; %bb.0:
; GFX112-NEXT:    s_mul_i32 s0, s0, s1
; GFX112-NEXT:    s_mov_b32 s1, 0
; GFX112-NEXT:    s_add_i32 s0, s0, s2
; GFX112-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX112-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX112-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX112-LABEL: s_mad_u16_sext:
; GFX112:       ; %bb.0:
; GFX112-NEXT:    s_mul_i32 s0, s0, s1
; GFX112-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX112-NEXT:    s_add_i32 s0, s0, s2
; GFX112-NEXT:    s_sext_i32_i16 s0, s0
; GFX112-NEXT:    ; return to shader part epilog
  %mul = mul i16 %arg0, %arg1
  %add = add i16 %mul, %arg2
