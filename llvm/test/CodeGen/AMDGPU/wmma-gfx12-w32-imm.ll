...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v11, v10 :: v_dual_mov_b32 v10, 0x40400000
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v12, v10 :: v_dual_mov_b32 v13, v10
; GCN-NEXT:    v_dual_mov_b32 v14, v10 :: v_dual_mov_b32 v15, v10
; GCN-NEXT:    v_dual_mov_b32 v16, v10 :: v_dual_mov_b32 v17, v10
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v11, v10 :: v_dual_mov_b32 v10, 0x42004200
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v11, v10 :: v_dual_mov_b32 v10, 0x3f803f80
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v12, v10 :: v_dual_mov_b32 v13, v10
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v11, v10 :: v_dual_mov_b32 v10, 0x3fc03fc0
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v12, v10 :: v_dual_mov_b32 v13, v10
; GCN-NEXT:    v_wmma_bf16_16x16x16_bf16 v[10:13], v[0:3], v[4:7], v[10:13]
; GCN-NEXT:    global_store_b128 v[8:9], v[10:13], off
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v7, v6 :: v_dual_mov_b32 v6, 0x80
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v8, v6 :: v_dual_mov_b32 v9, v6
; GCN-NEXT:    v_dual_mov_b32 v10, v6 :: v_dual_mov_b32 v11, v6
; GCN-NEXT:    v_dual_mov_b32 v12, v6 :: v_dual_mov_b32 v13, v6
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v5, v4 :: v_dual_mov_b32 v4, 0x80
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v6, v4 :: v_dual_mov_b32 v7, v4
; GCN-NEXT:    v_dual_mov_b32 v8, v4 :: v_dual_mov_b32 v9, v4
; GCN-NEXT:    v_dual_mov_b32 v10, v4 :: v_dual_mov_b32 v11, v4
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v7, v6 :: v_dual_mov_b32 v6, 0x40400000
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v8, v6 :: v_dual_mov_b32 v9, v6
; GCN-NEXT:    v_dual_mov_b32 v10, v6 :: v_dual_mov_b32 v11, v6
; GCN-NEXT:    v_dual_mov_b32 v12, v6 :: v_dual_mov_b32 v13, v6
