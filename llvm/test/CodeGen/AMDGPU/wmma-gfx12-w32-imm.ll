...
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX1170-NEXT:    v_dual_mov_b32 v11, v10 :: v_dual_mov_b32 v12, v10
; GFX1170-NEXT:    v_dual_mov_b32 v13, v10 :: v_dual_mov_b32 v14, v10
; GFX1170-NEXT:    v_dual_mov_b32 v15, v10 :: v_dual_mov_b32 v16, v10
...
; GFX12-NEXT:    v_dual_mov_b32 v16, v10 :: v_dual_mov_b32 v17, v10
...
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX1170-NEXT:    v_dual_mov_b32 v7, v6 :: v_dual_mov_b32 v8, v6
; GFX1170-NEXT:    v_dual_mov_b32 v9, v6 :: v_dual_mov_b32 v10, v6
; GFX1170-NEXT:    v_dual_mov_b32 v11, v6 :: v_dual_mov_b32 v12, v6
...
; GFX12-NEXT:    v_dual_mov_b32 v12, v6 :: v_dual_mov_b32 v13, v6
...
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX1170-NEXT:    v_dual_mov_b32 v5, v4 :: v_dual_mov_b32 v6, v4
; GFX1170-NEXT:    v_dual_mov_b32 v7, v4 :: v_dual_mov_b32 v8, v4
; GFX1170-NEXT:    v_dual_mov_b32 v9, v4 :: v_dual_mov_b32 v10, v4
...
; GFX12-NEXT:    v_dual_mov_b32 v10, v4 :: v_dual_mov_b32 v11, v4
