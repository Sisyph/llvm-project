...
; GFX12-NEXT:    v_dual_mov_b32 v2, v1 :: v_dual_add_f32 v1, -4.0, v2
...
; GFX12-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-TRUE16-NEXT:    s_wait_dscnt 0x0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v2, v1 :: v_dual_lshlrev_b32 v1, 16, v2
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX12-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-FAKE16-NEXT:    s_wait_dscnt 0x0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v2, v1 :: v_dual_lshlrev_b32 v1, 16, v2
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX12-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-TRUE16-NEXT:    s_wait_dscnt 0x0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_and_b32 v5, 0xffff0000, v4
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_dual_sub_f32 v5, v5, v3 :: v_dual_lshlrev_b32 v2, 16, v4
...
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_1)
...
; GFX12-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-FAKE16-NEXT:    s_wait_dscnt 0x0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_and_b32 v5, 0xffff0000, v4
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_dual_sub_f32 v5, v5, v1 :: v_dual_lshlrev_b32 v2, 16, v4
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-FAKE16-NEXT:    v_dual_sub_f32 v2, v2, v3 :: v_dual_cndmask_b32 v5, v7, v9
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
